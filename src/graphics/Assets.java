...
public class Assets {
    ...
    public static BufferedImage enemy, water, grass, nothing, rock, tree;
    ...
    public static void  init(){
        ...
        //btn_start[0] = sheet.crop(width * 6, height * 4, width,height);
        //btn_start[1] = sheet.crop(width * 6, height * 5, width, height);
